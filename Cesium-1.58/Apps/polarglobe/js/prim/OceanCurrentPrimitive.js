/////////////////////////////////////////////////////////
//INITIALIZED BY FENG @ MAY. 26TH, 2017 
//
/////////////////////////////////////////////////////////

Cesium.OceanCurrentPrimitive = function(){
	...
	var czm_x = 0, czm_y = 0;
	var _shader = Utils.loadFile("./shader/oceancurrent.glsl");

	var OceanCurrentPrimitive = function(options) {
	...
	OceanCurrentPrimitive.prototype = new PGPrimitive();
	OceanCurrentPrimitive.prototype.constructor = OceanCurrentPrimitive;

	OceanCurrentPrimitive.prototype.initialize = function(context,options){
		var prim = this;
        ...
        this._uniforms.uOCHeightRange = function() {
            return new Cartesian2(-prim.layerNum.from, -prim.layerNum.to);
        }
	...
	OceanCurrentPrimitive.prototype.onResize = function(context, width, height) {
    ...
    OceanCurrentPrimitive.prototype.onDataReady = function(context) {
        for (var i = 0; i < 32; i++) 
            evolve(this, context);
    }

    OceanCurrentPrimitive.prototype.render = function(context, cmdlist) { 
		//pick(this, context);
		evolve(this, context);
		fade(this, context);
	...
	OceanCurrentPrimitive.prototype.onAdjust = function(layerNum, heightMag) { 
		//callback	
	}

    OceanCurrentPrimitive.prototype.dispose = function() {
	...
	OceanCurrentPrimitive.prototype.setVisible = function(showed) {
		PGPrimitive.prototype.setVisible.call(this, showed);
        if(!showed)
            clear(this, scene.context);
    }

    OceanCurrentPrimitive.prototype.updateGeometry = function(options) {
        if (!options)
            return;
        ...
        if (options.layerNum) {
            ...
            this.layerNum = ln; 
            ret.autoHeight = 2e5 * ln.to / this._heights[ln.to - 1];
		}
